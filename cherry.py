...
def office_write():
    ...
    pyautogui.typewrite('Microsoft Office Word 2007',interval=0.2)
...
def main_window():
    ...
    while True:
        ...
        if query != None:
            ...
            elif 'type on Office Word 2007' in query:
           ...
           # elif 'search for' or 'weather' or 'time' in query:
